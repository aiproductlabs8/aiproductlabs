...
const agents = [
  ...
  },
  {
    ...
    desc: 'Paste a raw backlog or feature list. Applies RICE, MoSCoW, or weighted scoring with AI-generated reasoning for each item. Outputs a ranked list with justifications you can drop straight into Jira or Notion.',
    note: 'Opinionated prioritisation. Show your working.',
    tags: ['Claude API', 'Python', 'Product Management'],
    tagClasses: ['tc-cyan', 'tc-green', 'tc-purple'],
    delay: 'delay-3',
    comingSoon: true,
  ...
  },
  {
    ...
    desc: 'Describe a feature or initiative. Extracts every hidden assumption, rates each by risk level, and suggests validation methods for the dangerous ones. The thinking senior PMs do in their heads — made visible.',
    note: 'Ship less. Validate more.',
    tags: ['Claude API', 'Python', 'Product Management'],
    tagClasses: ['tc-cyan', 'tc-green', 'tc-purple'],
    delay: 'delay-1',
    comingSoon: true,
  ...
  {
    icon: '🗂️',
    title: 'Decision Log Agent',
    desc: 'Log product decisions with context — who was involved, what alternatives were considered, what was decided and why. AI auto-tags themes and surfaces relevant past decisions when you\'re about to make a related call.',
    note: 'Because \'why did we decide that?\' deserves an answer.',
    tags: ['Claude API', 'Agentic Memory', 'Python'],
  ...
  {
    icon: '🔄',
    title: 'Sprint Retro Synthesiser',
    desc: 'Feed it raw retro notes — sticky notes, Slack threads, survey responses. Clusters feedback into themes, identifies recurring patterns across sprints, and generates actionable recommendations ranked by team impact.',
    note: 'Turns retro noise into signal.',
    tags: ['Claude API', 'Python', 'Product Management'],
    tagClasses: ['tc-cyan', 'tc-green', 'tc-purple'],
    delay: 'delay-3',
    comingSoon: true,
  ...
  {
    icon: '✏️',
    title: 'User Story Refiner',
    desc: 'Paste rough user stories or requirements. Rewrites them with proper acceptance criteria, edge cases, and testable conditions. Flags vague language, missing personas, and scope creep before the ticket hits the board.',
    note: 'Definition of ready. Actually enforced.',
    tags: ['Claude API', 'Python', 'Product Management'],
    tagClasses: ['tc-cyan', 'tc-green', 'tc-purple'],
    delay: 'delay-1',
    comingSoon: true,
